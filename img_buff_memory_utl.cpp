...
VkDevice device, VkQueue queue) {
    VkCommandBuffer commandBuffer = beginSingleTimeCommands(cmdPool, device);
    ...
    endSingleTimeCommands(commandBuffer, queue, device, cmdPool);
}

/// <summary>
/// Copy a buffer to an image and submit it with a temporary command buffer
/// </summary>
...
void generateMipmaps(VkImage image, VkFormat imageFormat, int32_t texWidth, int32_t texHeight, uint32_t mipLevels, VkCommandPool cmdPool, VkDevice device, VkPhysicalDevice physicalDevice, VkQueue queue) {
